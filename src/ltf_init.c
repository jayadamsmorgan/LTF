...
static const char *luarc_contents =                                 //
    ...
    "    \"library\": [\n"                                          //
    "      \"~/.ltf/lib\",\n"                                       //
    "      \"/home/linuxbrew/.linuxbrew/opt/ltf/share/ltf/lib\",\n" //
    "      \"/opt/homebrew/opt/ltf/share/ltf/lib\",\n"              //
    "      \"/usr/local/opt/ltf/share/ltf/lib\"\n"                  //
    "    ]\n"                                                       //
    "\n"                                                            //
    "  }\n"                                                         //
    "\n"                                                            //
...
static int create_project(cmd_init_options *opts) {
    ...
    proj->min_ltf_ver_str = strdup(LTF_VERSION);
    proj->min_ltf_ver_major = LTF_VERSION_MAJOR;
    proj->min_ltf_ver_minor = LTF_VERSION_MINOR;
    proj->min_ltf_ver_patch = LTF_VERSION_PATCH;
...
int ltf_init() {
    ...
    LOG("Starting ltf init...");

    const char *proj_file = file_find_upwards(".ltf.json");
    if (proj_file && *proj_file) {
        LOG("Project already exists.");
        fprintf(
            stderr,
            "Already in the project, use 'ltf config' instead to tweak it.\n");
